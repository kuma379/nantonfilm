...
import { useGetTvshow } from "@workspace/api-client-react";
...
export default function TvShow() {
  ...
  const { data: response, isLoading, isError } = useGetTvshow({ page });
  const items: Item[] = (response as any)?.data || [];

  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-white mb-8">TV Show</h1>
